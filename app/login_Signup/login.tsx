  ...
  return (
     <SafeAreaView className="flex-1 bg-[#f6f6f8]">
      ...
      <View className="flex-1 px-4 pt-12 max-w-[480px] w-full self-center ">
        ...
        <TouchableOpacity className="h-14 w-full bg-[#1A5DFF] rounded-2xl items-center justify-center shadow-md active:scale-95 m-2">
      ...
      <View className="p-6 items-center">
        <Text className="text-sm text-gray-400 ">
          ...
          <Link href="/login_Signup/signup" className="text-[#1A5DFF] font-semibold">
            Register Shop
          </Link>
          </Text>
        </Text>
